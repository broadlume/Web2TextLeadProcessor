...
export async function CreateLead(request: Into<FfLeadRequest> | FfLeadRequest): Promise<FfLeadResponse> {
    ...
    const urlEncodedData = new URLSearchParams(ffLead as Record<string, string>).toString();
    try {
