...
> {
    ...
    abstract create(state: STATE, context: ObjectSharedContext<CONTEXT>): Promise<STATE>;
    abstract sync(state: STATE, context: ObjectSharedContext<CONTEXT>): Promise<STATE>;
    abstract close(state: STATE, context: ObjectSharedContext<CONTEXT>): Promise<STATE>;
}
