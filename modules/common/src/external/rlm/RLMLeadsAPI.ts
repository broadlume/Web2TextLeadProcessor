...
export async function CreateLead(
    ...
    try {
        ...
        logger.child({ label: "RLMLeadsAPI:CreateLead" }).warn(`Failed to post lead '${web2TextLeadId}' to RLM`);
...
export async function AttachNoteToLead(
    ...
    const note: RLMAttachNoteRequest = request instanceof Into ? request.into() : request;
