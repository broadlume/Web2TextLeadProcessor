...
export const ENV_FILE_SCHEMA = z
    .object({
        ...
        INTERNAL_API_TOKEN: z.string().uuid("Internal API Token must be a valid UUID").optional(),
        ...
        NEXUS_AWS_API_SECRET_NAME: z.string().min(1, "Nexus AWS API Secret Name is required"),
        ...
        LOCAL_DYNAMODB_URL: z.string().url("Local DynamoDB URL must be a valid URL").optional(),
        ...
        DEPLOYMENT_ENV: z
            .enum(["development", "production"], {
                errorMap: () => ({
                    message: "Deployment environment must be either 'development' or 'production'",
                }),
            })
            .optional(),
        ...
        PUBLIC_RESTATE_INGRESS_URL: z.string().url("Public Restate Ingress URL must be a valid URL").optional(),
        /** Botpress API token */
