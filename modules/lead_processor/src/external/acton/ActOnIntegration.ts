...
export class ActOnIntegration extends IExternalIntegration<SubmittedLeadState<ActOnLead>, ActOnIntegrationState> {
    Name = "ActOn";
    ...
    async create(
        ...
        const ActOnRes = await ActOnListAPI.CreateContactAPI(listId, leadState?.Lead).catch(
            (e) =>
                ({
                    status: "failure",
                    message: e,
