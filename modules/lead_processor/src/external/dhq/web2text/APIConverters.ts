...
export class Web2TextMessageIntoDhqComment extends Into<DHQStoreInquiryAPI.AddCommentRequest> {
    ...
    constructor(web2TextLead: SubmittedLeadState<Web2TextLead>, twilioMessage: Jsonify<MessageInstance>) {
        super();
    ...
    into(): DHQStoreInquiryAPI.AddCommentRequest {
        let senderName =
            this.twilioMessage.author === this.web2TextLead.Lead.PhoneNumber ? this.web2TextLead.Lead.Name : "Dealer";
...
export class Web2TextLeadIntoDHQStoreInquiry extends Into<DHQStoreInquiryAPI.StoreInquiryRequest> {
    ...
    constructor(web2TextLead: SubmittedLeadState<Web2TextLead>, storeInfo: NexusStoresAPI.RetailerStore) {
        super();
        this.web2TextLead = web2TextLead;
        ...
        const dhqLead: DHQStoreInquiryAPI.StoreInquiryRequest = {
            ...
            custom_fields: [
                ...
                },
                {
                    ...
                    value: this.web2TextLead.Integrations?.["Twilio"]?.Data?.ConversationSID ?? "null",
                    displayable: false,
                },
            ],
        };
