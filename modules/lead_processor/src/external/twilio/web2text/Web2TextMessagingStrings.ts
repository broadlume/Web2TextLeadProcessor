...
export function DealerGreetMessage(lead: SubmittedLeadState<Web2TextLead>, locationName: string): string {
...
export function CustomerCloseMessage(
    ...
    if (dealerName === null || (dealerWebsiteURL == null && storePhoneNumber == null)) {
        return message;
    }
