...
import { DeregisterThisServiceWithRestate, RegisterThisServiceWithRestate } from "./restate/server-helpers";
...
if (process.env.NODE_ENV === "production") {
    ...
    process.once("SIGTERM", async () => {
        await DeregisterThisServiceWithRestate(registeredRestateAddress!.address,RESTATE_PORT, {
            maxAttempts: 100,
            attemptDelayMs: 5000
